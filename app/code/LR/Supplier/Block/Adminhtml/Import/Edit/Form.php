 ...
 */
namespace LR\Supplier\Block\Adminhtml\Import\Edit;
...
class Form extends \Magento\ImportExport\Block\Adminhtml\Import\Edit\Form
{
    ...
    public function __construct(
        ...
        $this->imagesDirectoryProvider = $imageDirProvider ?? ObjectManager::getInstance()->get(Import\ImageDirectoryBaseProvider::class);
    ...
    protected function _prepareForm()
    {
        ...
        foreach ($uniqueBehaviors as $behaviorCode => $behaviorClass) {
            $fieldset = $form->addFieldset(
                ...
                ['legend' => __('Import Behavior-1'), 'class' => 'no-display']
            );
            $fieldset->addField(
                $behaviorCode.'1',
                'select',
