<?php
namespace Cellularisrael\BundleProduct\Model\Magento\Bundle\Model;
...
class LinkManagement extends \Magento\Bundle\Model\LinkManagement
{
    ...
    private function mapProductLinkToBundleSelectionModel(
        ...
        if ($productLink->getBundlePopupMessage() !== null) {
            $selectionModel->setBundlePopupMessage($productLink->getBundlePopupMessage());
        }
